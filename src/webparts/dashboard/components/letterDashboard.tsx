    ...
    if (ViewMode == "UnitHR") {
      for (var i = 0; i < HrUnitNames.length; i++) {
        ...
        await newweb.lists.getByTitle('Onboarding Transaction Master').items
          ...
          .filter(`BusinessUnit eq '${HrUnitNames[i]}' and Title eq 'LETTER OF AUTHORIZATION' and Status ne 'Completed'`)
          .get().then((items) => {
      ...
      <div >
        ...
        <div className="db-multiple-table mb-20 sec">
          <div className="dashboard-title clearfix">
            ...
            <div>
              <table id="exampleloa" className="display table-striped list_of_table">
                <thead>
                  <tr>
